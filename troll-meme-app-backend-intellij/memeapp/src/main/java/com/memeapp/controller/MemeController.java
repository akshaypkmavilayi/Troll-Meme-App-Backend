...
import com.memeapp.model.ResponseData;
...
//		}
		...
		@GetMapping("/getbyactorname/{actorname}")
		public List<MemeEntity> getMemebyActorNames(@PathVariable String actorname){
			MemeEntity memeEntity = new MemeEntity();
			memeEntity.setActorName(actorname);
			List<MemeEntity> memeEntityList = memeService.getMemeByActorName(memeEntity);
